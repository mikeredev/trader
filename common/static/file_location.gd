...
const THEME_HUD: String = "uid://ctglmnnwqwbq4"
...
const UI_HUD_COMPONENT_DISPLAY: String = "uid://df2ya0uji0y7j"

const USER_CONFIG_FILE: String = "user://settings/config.json"
const USER_ROOT_SAVE_DIR: String = "user://saves"
const USER_ROOT_SETTINGS_DIR: String = "user://settings"
const USER_ROOT_MOD_DIR: String = "user://mods"
