class_name AudioSettings extends ConfigUtility


func apply_config(_p_save: bool = false) -> void:
	Debug.log_info("Applying audio settings...")
...
static func from_dict(_p_dict: Variant) -> AudioSettings:
	var out: AudioSettings = AudioSettings.new()
