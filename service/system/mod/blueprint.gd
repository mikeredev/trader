...
func _init(p_world: Dictionary[String, Dictionary], p_country: Dictionary[String, Dictionary],
	p_city: Dictionary[String, Dictionary], p_trade: Dictionary[String, Dictionary]) -> void:
