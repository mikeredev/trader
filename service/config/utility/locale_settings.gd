class_name LocaleSettings extends ConfigUtility


func apply_config() -> void:
	Debug.log_info("Applying locale settings...")
...
static func from_dict(_p_dict: Dictionary) -> LocaleSettings:
	var out: LocaleSettings = LocaleSettings.new()
