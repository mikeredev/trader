...
static var character_manager: CharacterManager:
	get(): return System.service.character_manager

static var city_manager: CityManager:
	get(): return System.service.get_service(ServiceType.CITY_MANAGER)

static var config_manager: ConfigManager:
	get(): return System.service.get_service(ServiceType.CONFIG_MANAGER)

static var country_manager: CountryManager:
	get(): return System.service.get_service(ServiceType.COUNTRY_MANAGER)

static var dialog_manager: DialogManager:
	get(): return System.service.get_service(ServiceType.DIALOG_MANAGER)

static var mod_manager: ModManager:
	get(): return System.service.get_service(ServiceType.MOD_MANAGER)

static var scene_manager: SceneManager:
	get(): return System.service.get_service(ServiceType.SCENE_MANAGER)

static var session_manager: SessionManager:
	get(): return System.service.get_service(ServiceType.SESSION_MANAGER)

static var trade_manager: TradeManager:
	get(): return System.service.get_service(ServiceType.TRADE_MANAGER)

static var world_manager: WorldManager:
	get(): return System.service.get_service(ServiceType.WORLD_MANAGER)
