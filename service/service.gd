...
static var character_manager: CharacterManager:
	get(): return System.get_service(Service.Type.CHARACTER_MANAGER)

static var city_manager: CityManager:
	get(): return System.get_service(Service.Type.CITY_MANAGER)

static var config_manager: ConfigManager:
	get(): return System.get_service(Service.Type.CONFIG_MANAGER)

static var country_manager: CountryManager:
	get(): return System.get_service(Service.Type.COUNTRY_MANAGER)

static var dialog_manager: DialogManager:
	get(): return System.get_service(Service.Type.DIALOG_MANAGER)

static var mod_manager: ModManager:
	get(): return System.get_service(Service.Type.MOD_MANAGER)

static var scene_manager: SceneManager:
	get(): return System.get_service(Service.Type.SCENE_MANAGER)

static var session_manager: SessionManager:
	get(): return System.get_service(Service.Type.SESSION_MANAGER)

static var state_manager: StateManager:
	get(): return System.get_service(Service.Type.STATE_MANAGER)

static var trade_manager: TradeManager:
	get(): return System.get_service(Service.Type.TRADE_MANAGER)

static var world_manager: WorldManager:
	get(): return System.get_service(Service.Type.WORLD_MANAGER)
